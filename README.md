...
5. Добавить настройку разных лимитов для групп и PvP диалогов (`щас один лимит на всё :(`)
6. Добавить `javaDoc` по `BotQueue`
7. Добавить доку в `README.md` для настройки параметров `BotQueue`
8.  